...
from numpy import divide, multiply, number
...
lbinfo = Label(Tops, font=('aria', 30, 'bold'), text = "Restaurant Management System", fg= 'blue', bd=10, anchor=W)
lbinfo.grid(row=0, column=0)



lbinfo = Label(Tops, font=('aria', 30, 'bold'), text = localtime, fg = "red", anchor = W)
...
def ref():
    ...
    Totalcost = (fries_cost + fries_cost + lunch_cost + burger_cost + pizza_cost + cheese_burger_cost + drinks_cost)
...
subtract  = Button(f2, padx=16, pady = 16, bd = 4, fg="white", font=("arial", 20, 'bold'), text='-', bg= "black", command=lambda: btnclick("-"))
...
divide  = Button(f2, padx=16, pady = 16, bd = 4, fg="white", font=("arial", 20, 'bold'), text='/', bg= "black", command=lambda: btnclick("/"))
...
lblrefence = Label(f1, font=('aria', 16, 'bold'), text= "Order No.", fg = "black", bd=10, anchor=W )
lblrefence.grid(row=0, column=0)

txtreference = Entry(f1, font=('arial', 17, 'bold'), textvariable= rang, bd=6, insertwidth=4, bg="red", justify= "right")
...
lblservice_charger = Label(f1, font=('aria', 16, 'bold'), text= "Service Charge", fg = "black", bd=10, anchor=W )
...
def price():
    ...
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="__________",  fg="black", anchor=W)
    ...
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="25",  fg="red", bd=5, anchor=W)
    lblinfo.grid(row=1, column=5)


    lblinfo = Label(x, font=('aria', 15, 'bold'), text="Lunch Meal",  fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="40",  fg="red", bd=5, anchor=W)
    lblinfo.grid(row=2, column=5)


    lblinfo = Label(x, font=('aria', 15, 'bold'), text="Burger Meal",  fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=0)
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="35",  fg="red", bd=5, anchor=W)
    lblinfo.grid(row=3, column=5)


    lblinfo = Label(x, font=('aria', 15, 'bold'), text="Pizza Meal",  fg="steel blue", anchor=W)
    lblinfo.grid(row=4, column=0)
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="50",  fg="red", bd=5, anchor=W)
    lblinfo.grid(row=4, column=5)


    lblinfo = Label(x, font=('aria', 15, 'bold'), text="Chesse burger",  fg="steel blue", anchor=W)
    lblinfo.grid(row=5, column=0)
    lblinfo = Label(x, font=('aria', 15, 'bold'), text="30",  fg="red", bd=5, anchor=W)
...
btnprice = Button(f1, padx=16, pady=8, bd =10, fg="white", bg="black", font=('arial', 16, 'bold'), width=10, text= "PRICE", command= price)
btnprice.grid(row=7, column=0)



btntotal = Button(f1, padx=16, pady=8, bd =10, fg="white", bg="black", font=('arial', 16, 'bold'), width=10, text= "TOTAL", command= ref)
btntotal.grid(row=7, column=1)



btnreset = Button(f1, padx=16, pady=8, bd =10, fg="white", bg="black", font=('arial', 16, 'bold'), width=10, text= "RESET", command= rezet)
btnreset.grid(row=7, column=2)



btnexit = Button(f1, padx=16, pady=8, bd =10, fg="white", bg="black", font=('arial', 16, 'bold'), width=10, text= "EXIT", command= qexit)
